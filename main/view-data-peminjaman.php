            ...
            <div class="row row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header row g-2 ms-auto">
                            <div class="card-title ">
                                <div class="pr-2">
                                    <a href="../konfigurasi/print/print-semua-data-peminjaman-excel.php?"
                                        class="btn btn-dark" style="width: 100px;">
                                        <i class="fa fa-file-excel" style="margin: 2px;">&nbsp;</i>Excel full
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="card-header row g-2 align-items-center">
                            <div class="card-title d-flex justify-content-between">
                                ...
                                <div class="pr-2">
                                    <a href="input-data-peminjaman.php" class=" btn btn-teal" style="width: 90px;">
                                ...
                                <div class="col-xl-12">
                                    <div class="table-responsive">
                                        <table class="table card-table text-center table-nowrap" style="height: 400px;">
                                            ...
                                            <tbody>
                                                <?php
                                                    require '../konfigurasi/view-data/konfig-view-data-peminjaman.php'
                                                    ?>
                                            </tbody>
                                        </table>
                                    </div>
